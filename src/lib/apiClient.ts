...
export const api = {
  ...
  // --- Copilot Voice Notes ---
  generateVoiceNote: (text: string, options?: { feedback?: string; ambient_noise?: string | null; ambient_level?: number; humanize?: boolean }) =>
  ...
  // Calendly Booking URL (Settings > Integrations)
